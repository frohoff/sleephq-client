...
T = TypeVar("T", bound="ApiV1ImportsFileSerializerDataAttributes")


@_attrs_define
class ApiV1ImportsFileSerializerDataAttributes:
    """
    Attributes:
        id (int | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        api_v1_imports_file_serializer_data_attributes = cls(
            id=id,
        ...
        api_v1_imports_file_serializer_data_attributes.additional_properties = d
        return api_v1_imports_file_serializer_data_attributes
