...
T = TypeVar("T", bound="ApiV1JournalSerializerListDataItemAttributes")


@_attrs_define
class ApiV1JournalSerializerListDataItemAttributes:
    """
    Attributes:
        id (int | Unset):
        team_id (int | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        api_v1_journal_serializer_list_data_item_attributes = cls(
            id=id,
            team_id=team_id,
            date=date,
        ...
        api_v1_journal_serializer_list_data_item_attributes.additional_properties = d
        return api_v1_journal_serializer_list_data_item_attributes
