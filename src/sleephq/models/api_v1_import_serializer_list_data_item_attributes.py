...
T = TypeVar("T", bound="ApiV1ImportSerializerListDataItemAttributes")


@_attrs_define
class ApiV1ImportSerializerListDataItemAttributes:
    """
    Attributes:
        id (int | Unset):
        team_id (int | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        api_v1_import_serializer_list_data_item_attributes = cls(
            id=id,
            team_id=team_id,
            name=name,
            status=status,
        ...
        api_v1_import_serializer_list_data_item_attributes.additional_properties = d
        return api_v1_import_serializer_list_data_item_attributes
