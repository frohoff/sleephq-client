...
T = TypeVar("T", bound="PutV1JournalsIdBody")


@_attrs_define
class PutV1JournalsIdBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_v1_journals_id_body.additional_properties = d
        return put_v1_journals_id_body
