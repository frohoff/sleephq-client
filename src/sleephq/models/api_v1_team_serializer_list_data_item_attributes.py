...
T = TypeVar("T", bound="ApiV1TeamSerializerListDataItemAttributes")


@_attrs_define
class ApiV1TeamSerializerListDataItemAttributes:
    """
    Attributes:
        id (int | Unset):
        name (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        api_v1_team_serializer_list_data_item_attributes = cls(
            id=id,
            name=name,
            owner_id=owner_id,
            time_zone=time_zone,
        ...
        api_v1_team_serializer_list_data_item_attributes.additional_properties = d
        return api_v1_team_serializer_list_data_item_attributes
