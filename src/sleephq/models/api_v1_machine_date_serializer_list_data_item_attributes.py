...
if TYPE_CHECKING:
    from ..models.api_v1_machine_date_serializer_list_data_item_attributes_ahi_summary import (
        ApiV1MachineDateSerializerListDataItemAttributesAhiSummary,
    )
    from ..models.api_v1_machine_date_serializer_list_data_item_attributes_epap_summary import (
        ApiV1MachineDateSerializerListDataItemAttributesEpapSummary,
    )
    from ..models.api_v1_machine_date_serializer_list_data_item_attributes_flow_limit_summary import (
        ApiV1MachineDateSerializerListDataItemAttributesFlowLimitSummary,
    )
    from ..models.api_v1_machine_date_serializer_list_data_item_attributes_leak_rate_summary import (
        ApiV1MachineDateSerializerListDataItemAttributesLeakRateSummary,
    )
    from ..models.api_v1_machine_date_serializer_list_data_item_attributes_machine_settings import (
        ApiV1MachineDateSerializerListDataItemAttributesMachineSettings,
    )
    from ..models.api_v1_machine_date_serializer_list_data_item_attributes_movement_summary import (
        ApiV1MachineDateSerializerListDataItemAttributesMovementSummary,
    )
    from ..models.api_v1_machine_date_serializer_list_data_item_attributes_pressure_summary import (
        ApiV1MachineDateSerializerListDataItemAttributesPressureSummary,
    )
    from ..models.api_v1_machine_date_serializer_list_data_item_attributes_pulse_rate_summary import (
        ApiV1MachineDateSerializerListDataItemAttributesPulseRateSummary,
    )
    from ..models.api_v1_machine_date_serializer_list_data_item_attributes_resp_rate_summary import (
        ApiV1MachineDateSerializerListDataItemAttributesRespRateSummary,
    )
    from ..models.api_v1_machine_date_serializer_list_data_item_attributes_spo_2_summary import (
        ApiV1MachineDateSerializerListDataItemAttributesSpo2Summary,
    )


T = TypeVar("T", bound="ApiV1MachineDateSerializerListDataItemAttributes")


@_attrs_define
class ApiV1MachineDateSerializerListDataItemAttributes:
    """
    Attributes:
        id (int | Unset):
        usage (int | Unset):
        ...
        ahi_summary (ApiV1MachineDateSerializerListDataItemAttributesAhiSummary | Unset):
        pressure_summary (ApiV1MachineDateSerializerListDataItemAttributesPressureSummary | Unset):
        leak_rate_summary (ApiV1MachineDateSerializerListDataItemAttributesLeakRateSummary | Unset):
        flow_limit_summary (ApiV1MachineDateSerializerListDataItemAttributesFlowLimitSummary | Unset):
        resp_rate_summary (ApiV1MachineDateSerializerListDataItemAttributesRespRateSummary | Unset):
        epap_summary (ApiV1MachineDateSerializerListDataItemAttributesEpapSummary | Unset):
        machine_settings (ApiV1MachineDateSerializerListDataItemAttributesMachineSettings | Unset):
        pulse_rate_summary (ApiV1MachineDateSerializerListDataItemAttributesPulseRateSummary | Unset):
        spo2_summary (ApiV1MachineDateSerializerListDataItemAttributesSpo2Summary | Unset):
        movement_summary (ApiV1MachineDateSerializerListDataItemAttributesMovementSummary | Unset):
    """
    ...
    ahi_summary: ApiV1MachineDateSerializerListDataItemAttributesAhiSummary | Unset = UNSET
    pressure_summary: ApiV1MachineDateSerializerListDataItemAttributesPressureSummary | Unset = UNSET
    leak_rate_summary: ApiV1MachineDateSerializerListDataItemAttributesLeakRateSummary | Unset = UNSET
    flow_limit_summary: ApiV1MachineDateSerializerListDataItemAttributesFlowLimitSummary | Unset = UNSET
    resp_rate_summary: ApiV1MachineDateSerializerListDataItemAttributesRespRateSummary | Unset = UNSET
    epap_summary: ApiV1MachineDateSerializerListDataItemAttributesEpapSummary | Unset = UNSET
    machine_settings: ApiV1MachineDateSerializerListDataItemAttributesMachineSettings | Unset = UNSET
    pulse_rate_summary: ApiV1MachineDateSerializerListDataItemAttributesPulseRateSummary | Unset = UNSET
    spo2_summary: ApiV1MachineDateSerializerListDataItemAttributesSpo2Summary | Unset = UNSET
    movement_summary: ApiV1MachineDateSerializerListDataItemAttributesMovementSummary | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_ahi_summary, Unset):
            ...
            ahi_summary = ApiV1MachineDateSerializerListDataItemAttributesAhiSummary.from_dict(_ahi_summary)
        ...
        if isinstance(_pressure_summary, Unset):
            ...
            pressure_summary = ApiV1MachineDateSerializerListDataItemAttributesPressureSummary.from_dict(
                _pressure_summary
            )
        ...
        if isinstance(_leak_rate_summary, Unset):
            ...
            leak_rate_summary = ApiV1MachineDateSerializerListDataItemAttributesLeakRateSummary.from_dict(
                _leak_rate_summary
            )
        ...
        if isinstance(_flow_limit_summary, Unset):
            ...
            flow_limit_summary = ApiV1MachineDateSerializerListDataItemAttributesFlowLimitSummary.from_dict(
                _flow_limit_summary
            )
        ...
        if isinstance(_resp_rate_summary, Unset):
            ...
            resp_rate_summary = ApiV1MachineDateSerializerListDataItemAttributesRespRateSummary.from_dict(
                _resp_rate_summary
            )
        ...
        if isinstance(_epap_summary, Unset):
            ...
            epap_summary = ApiV1MachineDateSerializerListDataItemAttributesEpapSummary.from_dict(_epap_summary)
        ...
        if isinstance(_machine_settings, Unset):
            ...
            machine_settings = ApiV1MachineDateSerializerListDataItemAttributesMachineSettings.from_dict(
                _machine_settings
            )
        ...
        if isinstance(_pulse_rate_summary, Unset):
            ...
            pulse_rate_summary = ApiV1MachineDateSerializerListDataItemAttributesPulseRateSummary.from_dict(
                _pulse_rate_summary
            )
        ...
        if isinstance(_spo2_summary, Unset):
            ...
            spo2_summary = ApiV1MachineDateSerializerListDataItemAttributesSpo2Summary.from_dict(_spo2_summary)
        ...
        if isinstance(_movement_summary, Unset):
            ...
            movement_summary = ApiV1MachineDateSerializerListDataItemAttributesMovementSummary.from_dict(
                _movement_summary
            )

        api_v1_machine_date_serializer_list_data_item_attributes = cls(
            id=id,
            usage=usage,
        ...
        api_v1_machine_date_serializer_list_data_item_attributes.additional_properties = d
        return api_v1_machine_date_serializer_list_data_item_attributes
